...
public class FX_STUB {
		...
		public static void main(String[] args) {
			...
			String Rename_Tag="GPPReference";
			String Folder_Path="C:\\Stubs\\FX";
			...
			try {
				...
				//Request reading and storing part
					...
					String Local=strmsg.substring(strmsg.indexOf("<Local>")+7,strmsg.indexOf("</Local>"));
				   
			        String out="<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
			        		+"<Document><FX><RequestMessageRef>"
			        		+"<SourceSystemReference>"+Local+"</SourceSystemReference>"
			        		+"</FX></Document>";
